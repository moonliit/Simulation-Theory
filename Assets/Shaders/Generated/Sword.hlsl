...
float GetSwordDist(float3 p, int baseIdx, float smoothness)
{
    ...
    float step_1 = smax(prim_3, -(prim_4), smoothness);
    float step_2 = smax(step_1, -(prim_5), smoothness);
    float step_3 = smin(step_0, prim_2, smoothness);
