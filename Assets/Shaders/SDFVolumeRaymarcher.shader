Shader "Custom/SdfVolumeRaymarcher"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            uniform float4x4 _CharMatrices[16];
            uniform float4 _CharData[16];
            uniform int _ActiveCsgInstanceCount;
            uniform float _CsgInstanceOffsets[16];
            ...
            #include "CustomCharacterSdf.hlsl"
            ...
            float GetSceneSdf(float3 p)
            {
                ...
                for (int instanceIdx = 0; instanceIdx < _ActiveCsgInstanceCount; instanceIdx++)
                {
                    ...
                    float dSwordInstance = GetSwordDist(p, baseBufferIndex);
                    finalDist = smin(finalDist, dSwordInstance, 1.0);
                }
